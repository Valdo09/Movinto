...
@section('content')
    <div class="row justify-content-center form-bg-image" data-background-lg="{{asset("back/assets/img/illustrations/signin.svg")}}">
                ...
                <form action="#" class="mt-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between align-items-top mb-4">
                            ...
                            <div><a href="./forgot-password.html" class="small text-right">Mot de passe oublié?</a></div>
                        </div>
                    </div>
                    <div class="d-grid">
                ...
                <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                  Vous n'avez pas un compte?
                                    <a href="" class="fw-bold">Creer un compte</a>
                                </span>
                </div>
