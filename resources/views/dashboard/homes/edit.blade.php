        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modifier une maison</li>
                </ol>
            </nav>
            <h2 class="h4">Modifier une maison</h2>
        </div>
...
<form action="{{route('admin.homes.update',$item->id)}}" method="POST">
    @method('PUT')
    @csrf
    <div class="row py-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <input type="text" name="rooms_number" id="" class="form-control" value="{{$item->rooms_number}}">
                                <small class="form-text text-muted">Calavi, Cxxx</small>
                            </div>
