    ...
    <div class="animated fadeIn">
        ...
        <div class="">
           ...
           Modification d'une parcelle
            <form action="{{route('admin.lands.update',$item->id)}}" class="row" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select data-placeholder="Meublé" class="standardSelect" tabindex="1" name="rehoused">
                                    @if($item->isRehoused)
