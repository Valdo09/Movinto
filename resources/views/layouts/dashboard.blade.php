...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('css/dashboard/css/cs-skin-elastic.css')}}">
...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="{{route('admin.owners.show')}}">Propriétaires</a></li>
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="{{route('admin.customers.show')}}">Clients</a></li>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{URL::asset('images/profile.png')}}" alt="User Avatar">
                        </a>
    ...
    <script src="{{URL::asset('css/dashboard/js/main.js')}}"></script>
    ...
    <script src="{{URL::asset('css/dashboard/js/init/weather-init.js')}}"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="{{URL::asset('css/dashboard/js/init/fullcalendar-init.js')}}"></script>
    <script src="{{URL::asset('css/dashboard/js/lib/chosen/chosen.jquery.min.js')}}"></script>
