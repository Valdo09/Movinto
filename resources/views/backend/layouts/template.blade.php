...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Movinto | Tableau de bord</title>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('back/assets/img/favicon/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('back/assets/img/favicon/favicon-32x32.png')}}">
